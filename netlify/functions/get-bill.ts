...
import { Handler } from '@netlify/functions'; // If using Netlify Functions runtime
...
function logDebug(...args: any[]) {
  if (LOG_LEVEL === 'debug') console.debug('[get-bill]', ...args);
}
function logInfo(...args: any[]) {
  if (['debug','info'].includes(LOG_LEVEL)) console.info('[get-bill]', ...args);
}
function logWarn(...args: any[]) {
  if (['debug','info','warn'].includes(LOG_LEVEL)) console.warn('[get-bill]', ...args);
}
